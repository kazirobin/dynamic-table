    ...
    return (
      <div className="bg-[#0077b6]   mx-auto">
        <div className="max-w-4xl mx-auto py-4">
          ...
          <h1 className="font-bold text-3xl">This is a Table of Recipes</h1>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody>
                  {recipes.map((recipe) => (
                    ...
                    >
                      <td className="px-4 sm:px-6 py-3 sm:py-4">{recipe.name}</td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4">{recipe.cuisine}</td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4"><img src={recipe.image} className="w-15" alt="" /></td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4">{recipe.prepTimeMinutes} minutes</td>
                      <td className="px-4 sm:px-6 py-3 sm:py-4">{recipe.rating}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
